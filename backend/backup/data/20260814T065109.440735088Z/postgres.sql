...
\restrict dcbScWmWf2PhPZVakUUeRZ9I09bJv76R8JaFSE6dhU55tJkaJ16f01kwi7Jf4eC
...
DROP POLICY IF EXISTS isolate_tenant_data ON public.tenants;
...
ALTER TABLE IF EXISTS ONLY public.rbac_user_roles DROP CONSTRAINT IF EXISTS rbac_user_roles_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.rbac_user_roles DROP CONSTRAINT IF EXISTS rbac_user_roles_role_id_fkey;
ALTER TABLE IF EXISTS ONLY public.rbac_roles DROP CONSTRAINT IF EXISTS rbac_roles_inherits_from_fkey;
ALTER TABLE IF EXISTS ONLY public.rbac_role_permissions DROP CONSTRAINT IF EXISTS rbac_role_permissions_role_id_fkey;
ALTER TABLE IF EXISTS ONLY public.rbac_audit_logs DROP CONSTRAINT IF EXISTS rbac_audit_logs_role_id_fkey;
ALTER TABLE IF EXISTS ONLY public.rbac_audit_logs DROP CONSTRAINT IF EXISTS rbac_audit_logs_actor_user_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.business_type_aliases DROP CONSTRAINT IF EXISTS business_type_aliases_business_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.business_plan_modules DROP CONSTRAINT IF EXISTS business_plan_modules_module_id_fkey;
ALTER TABLE IF EXISTS ONLY public.business_plan_modules DROP CONSTRAINT IF EXISTS business_plan_modules_business_type_plan_id_fkey;
ALTER TABLE IF EXISTS ONLY public.business_plan_matrix DROP CONSTRAINT IF EXISTS business_plan_matrix_plan_id_fkey;
ALTER TABLE IF EXISTS ONLY public.auth_sessions DROP CONSTRAINT IF EXISTS auth_sessions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.auth_password_reset_requests DROP CONSTRAINT IF EXISTS auth_password_reset_requests_user_id_fkey;
DROP INDEX IF EXISTS public.idx_tenant_subscriptions_status;
DROP INDEX IF EXISTS public.idx_tenant_modules_tenant_enabled;
DROP INDEX IF EXISTS public.idx_rbac_user_roles_user;
DROP INDEX IF EXISTS public.idx_rbac_roles_status;
DROP INDEX IF EXISTS public.idx_rbac_permissions_role;
DROP INDEX IF EXISTS public.idx_rbac_audit_created;
DROP INDEX IF EXISTS public.idx_plans_status_sort;
DROP INDEX IF EXISTS public.idx_modules_status_sort;
DROP INDEX IF EXISTS public.idx_cloud_tenant_id;
DROP INDEX IF EXISTS public.idx_cloud_idempotency;
DROP INDEX IF EXISTS public.idx_cloud_email;
DROP INDEX IF EXISTS public.idx_client_register_status_created;
DROP INDEX IF EXISTS public.idx_client_register_email_lower;
DROP INDEX IF EXISTS public.idx_client_business_register_status;
DROP INDEX IF EXISTS public.idx_client_business_register_email;
DROP INDEX IF EXISTS public.idx_client_business_register_company_name;
DROP INDEX IF EXISTS public.idx_client_business_register_business_type;
DROP INDEX IF EXISTS public.idx_business_plan_modules_plan;
DROP INDEX IF EXISTS public.idx_business_plan_matrix_plan;
DROP INDEX IF EXISTS public.idx_auth_users_tenant_id;
DROP INDEX IF EXISTS public.idx_auth_users_status;
DROP INDEX IF EXISTS public.idx_auth_users_role;
DROP INDEX IF EXISTS public.idx_auth_sessions_user_id;
DROP INDEX IF EXISTS public.idx_auth_sessions_revoked_at;
DROP INDEX IF EXISTS public.idx_auth_sessions_expires_at;
DROP INDEX IF EXISTS public.idx_auth_password_reset_expires;
DROP INDEX IF EXISTS public.idx_auth_password_reset_email_created;
DROP INDEX IF EXISTS public.idx_auth_audit_logs_user_id;
DROP INDEX IF EXISTS public.idx_auth_audit_logs_tenant_id;
DROP INDEX IF EXISTS public.idx_auth_audit_logs_created_at;
ALTER TABLE IF EXISTS ONLY public.tenants DROP CONSTRAINT IF EXISTS tenants_tenant_id_key;
ALTER TABLE IF EXISTS ONLY public.tenants DROP CONSTRAINT IF EXISTS tenants_pkey;
ALTER TABLE IF EXISTS ONLY public.tenants DROP CONSTRAINT IF EXISTS tenants_idempotency_key_key;
ALTER TABLE IF EXISTS ONLY public.tenants DROP CONSTRAINT IF EXISTS tenants_email_key;
...
ALTER TABLE IF EXISTS ONLY public.rbac_role_permissions DROP CONSTRAINT IF EXISTS rbac_role_permissions_pkey;
ALTER TABLE IF EXISTS ONLY public.rbac_audit_logs DROP CONSTRAINT IF EXISTS rbac_audit_logs_pkey;
...
ALTER TABLE IF EXISTS ONLY public.client_business_register DROP CONSTRAINT IF EXISTS client_business_register_pkey;
ALTER TABLE IF EXISTS ONLY public.client_business_register DROP CONSTRAINT IF EXISTS client_business_register_email_key;
ALTER TABLE IF EXISTS ONLY public.business_types DROP CONSTRAINT IF EXISTS business_types_pkey;
ALTER TABLE IF EXISTS ONLY public.business_type_aliases DROP CONSTRAINT IF EXISTS business_type_aliases_pkey;
ALTER TABLE IF EXISTS ONLY public.business_plan_modules DROP CONSTRAINT IF EXISTS business_plan_modules_pkey;
ALTER TABLE IF EXISTS ONLY public.business_plan_matrix DROP CONSTRAINT IF EXISTS business_plan_matrix_pkey;
...
ALTER TABLE IF EXISTS ONLY public.auth_sessions DROP CONSTRAINT IF EXISTS auth_sessions_session_hash_key;
ALTER TABLE IF EXISTS ONLY public.auth_sessions DROP CONSTRAINT IF EXISTS auth_sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.auth_password_reset_requests DROP CONSTRAINT IF EXISTS auth_password_reset_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.auth_audit_logs DROP CONSTRAINT IF EXISTS auth_audit_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.api_idempotency_keys DROP CONSTRAINT IF EXISTS api_idempotency_keys_pkey;
ALTER TABLE IF EXISTS public.rbac_audit_logs ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.rbac_audit_logs_id_seq;
DROP TABLE IF EXISTS public.rbac_audit_logs;
DROP TABLE IF EXISTS public.plans;
DROP TABLE IF EXISTS public.plan_modules;
DROP TABLE IF EXISTS public.modules;
DROP TABLE IF EXISTS public.client_business_register;
DROP TABLE IF EXISTS public.business_types;
DROP TABLE IF EXISTS public.business_type_aliases;
DROP TABLE IF EXISTS public.business_plan_modules;
DROP TABLE IF EXISTS public.business_plan_matrix;
DROP TABLE IF EXISTS public.backup_tenant_subscriptions_switch_20260617_110635;
DROP TABLE IF EXISTS public.backup_tenant_subscriptions_cleanup_20260617_105755;
DROP TABLE IF EXISTS public.backup_tenant_subscriptions_business_v2_20260617_073934;
DROP TABLE IF EXISTS public.backup_tenant_subscriptions_business_v1_20260617_072332;
DROP TABLE IF EXISTS public.backup_tenant_modules_switch_20260617_110635;
DROP TABLE IF EXISTS public.backup_tenant_modules_cleanup_20260617_105755;
DROP TABLE IF EXISTS public.backup_tenant_modules_business_v2_20260617_073934;
DROP TABLE IF EXISTS public.backup_tenant_modules_business_v1_20260617_072332;
DROP TABLE IF EXISTS public.backup_plans_after_global_20260616_210346;
DROP TABLE IF EXISTS public.backup_plan_modules_after_global_20260616_210346;
DROP TABLE IF EXISTS public.backup_business_types_20260616_222209;
DROP TABLE IF EXISTS public.backup_business_type_aliases_20260616_222209;
DROP TABLE IF EXISTS public.backup_business_plan_modules_official_20260616_222612;
DROP TABLE IF EXISTS public.backup_business_plan_modules_20260616_215352;
DROP TABLE IF EXISTS public.backup_business_plan_matrix_official_20260616_222612;
DROP TABLE IF EXISTS public.backup_business_plan_matrix_20260616_215352;
DROP TABLE IF EXISTS public.auth_users;
DROP TABLE IF EXISTS public.auth_sessions;
DROP TABLE IF EXISTS public.auth_password_reset_requests;
...
b9358445-1c59-4a70-98b7-b0d1ac2e3d91	adb6bf84-0d87-4ffc-a571-49dca2d19c70	system	superadmin@softcodesolution.local	login_success	role=super_admin	39.34.188.167	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36	2026-08-14 06:50:45.902396+00
\.
...
7881fe47-36b7-4623-8545-931a71f5ce64	adb6bf84-0d87-4ffc-a571-49dca2d19c70	4d60b8abff4ebb989a37cf202a73f1fdf70a5c3d7885a88082eb2176ac8fe245	39.34.188.167	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36	2026-09-13 06:50:45.765593+00	\N	2026-08-14 06:50:45.767163+00	2026-08-14 06:50:45.767163+00
\.
...
adb6bf84-0d87-4ffc-a571-49dca2d19c70	system	superadmin@softcodesolution.local	$argon2id$v=19$m=65536,t=3,p=2$V/C2ml7LUKexNVy/xKJikw$B+bt8pSq+zmrFeEOitT5bn6ne6z4IghSfqqREjFNYEc	super_admin	active	0	\N	2026-08-14 06:50:45.869519+00	2026-06-07 09:52:43.358137+00	2026-08-14 06:50:45.869519+00	f
\.
...
accounting_tax	Accounting & Tax Services	accounting_tax	1.00	active	10	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
agriculture	Agriculture & Farming	agriculture	1.00	active	20	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
auto_workshop	Auto Workshop & Garage	auto_workshop	1.00	active	30	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
clinic	Clinic / Healthcare Center	clinic	1.10	active	40	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
hospital	Hospital Management	clinic	1.30	active	50	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
dental	Dental Clinic	dental	1.05	active	60	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
pharmacy	Pharmacy & Medical Store	pharmacy	1.05	active	70	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
school_college	School / College Management	school	1.15	active	80	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
coaching_center	Coaching & Training Center	school	0.95	active	90	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
ecommerce	eCommerce / Online Store	ecommerce	1.05	active	100	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
retail_shop	Retail Shop / General Store	store	1.00	active	110	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
super_mart	Super Mart & Grocery	store	1.10	active	120	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
wholesale_distribution	Wholesale & Distribution	store	1.10	active	130	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
restaurant_cafe	Restaurant & Cafe	restaurant	1.10	active	140	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
hotel_hospitality	Hotel & Hospitality	hotel	1.15	active	150	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
travel_tourism	Travel & Tourism	travel	1.15	active	160	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
salon_spa	Beauty Salon & Spa	salon	1.00	active	170	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
gym_fitness	Gym & Fitness Center	gym	0.95	active	180	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
real_estate	Property & Real Estate	real_estate	1.10	active	190	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
construction	Construction Business	construction	1.10	active	200	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
manufacturing	Manufacturing & Factory	manufacturing	1.20	active	210	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
logistics_transport	Logistics & Transport	logistics	1.10	active	220	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
event_management	Event Management	event_management	1.00	active	230	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
hr_payroll	HR & Payroll Services	hr_recruitment	1.00	active	240	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
recruitment_agency	Recruitment Agency	hr_recruitment	1.00	active	250	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
law_firm	Legal Firm / Law Office	law_firm	1.00	active	260	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
ngo_nonprofit	NGO / Nonprofit Organization	ngo	0.95	active	270	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
professional_services	Professional Services	professional_services	1.00	active	280	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
software_it	Software & IT Services	professional_services	1.10	active	290	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
home_services	Home & Maintenance Services	services	0.95	active	300	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
security_services	Security Services	security	1.00	active	310	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
cleaning_services	Cleaning Services	services	0.95	active	320	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
media_marketing	Media & Marketing Agency	communication	1.00	active	330	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
telecom_communication	Telecom & Communication	communication	1.05	active	340	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
other_business	Other Business Type	business	1.00	active	350	2026-06-16 22:22:09.989076+00	2026-08-14 06:50:50.330584+00
\.
...
ecommerce_shipping	Shipping	ecommerce	1200.00	12000.00	ecommerce-shipping	Truck	active	1810	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
ecommerce_coupons	Coupons	ecommerce	900.00	9000.00	ecommerce-coupons	BadgePercent	active	1820	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
ecommerce_reviews	Reviews	ecommerce	800.00	8000.00	ecommerce-reviews	Star	active	1830	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
ecommerce_marketplace	Marketplace Vendors	ecommerce	2200.00	22000.00	ecommerce-marketplace	Store	active	1840	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
school_management	School Management	school	3500.00	35000.00	school	GraduationCap	active	110	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
students	Students	school	1000.00	10000.00	students	Users	active	120	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
teachers	Teachers	school	1000.00	10000.00	teachers	UserCog	active	130	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
fees	Fees & Billing	school	1500.00	15000.00	fees	CreditCard	active	160	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
doctors	Doctors	clinic	1000.00	10000.00	doctors	UserCog	active	330	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
core_dashboard	Dashboard	core	0.00	0.00	dashboard	LayoutDashboard	active	1000	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_company_profile	Company Profile	core	500.00	5000.00	company-profile	Building2	active	1010	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_branches	Branches	core	800.00	8000.00	branches	GitBranch	active	1020	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_users	Users	core	1000.00	10000.00	users	Users	active	1030	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_roles_permissions	Roles & Permissions	core	1200.00	12000.00	roles-permissions	ShieldCheck	active	1040	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_files	Files & Documents	core	800.00	8000.00	files	FolderOpen	active	1050	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_calendar	Calendar	core	700.00	7000.00	calendar	Calendar	active	1060	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
restaurant_reservations	Reservations	restaurant	1200.00	12000.00	restaurant-reservations	CalendarCheck	active	1200	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
restaurant_delivery_orders	Delivery Orders	restaurant	1400.00	14000.00	restaurant-delivery	Bike	active	1210	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
restaurant_food_inventory	Food Inventory	restaurant	1300.00	13000.00	restaurant-food-inventory	Boxes	active	1220	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
restaurant_waiter_app	Waiter App	restaurant	1100.00	11000.00	restaurant-waiter	Smartphone	active	1230	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
restaurant_recipe_costing	Recipe Costing	restaurant	1200.00	12000.00	restaurant-recipe-costing	Calculator	active	1240	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
restaurant_floor_plan	Floor Plan	restaurant	1000.00	10000.00	restaurant-floor-plan	LayoutGrid	active	1250	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
restaurant_modifiers_addons	Modifiers & Add-ons	restaurant	900.00	9000.00	restaurant-modifiers	ListPlus	active	1260	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
restaurant_shift_cash	Shift & Cash Closing	restaurant	1200.00	12000.00	restaurant-shift-cash	Receipt	active	1270	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
salon_packages	Packages	salon	1000.00	10000.00	salon-packages	PackagePlus	active	1570	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
salon_products	Beauty Products	salon	900.00	9000.00	salon-products	ShoppingBag	active	1580	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
salon_commission	Staff Commission	salon	1100.00	11000.00	salon-commission	Percent	active	1590	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
school_transport	Transport	school	1200.00	12000.00	school-transport	Bus	active	1300	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
school_certificates	Certificates	school	800.00	8000.00	school-certificates	Award	active	1350	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
clinic_lab_reports	Lab Reports	clinic	1200.00	12000.00	clinic-lab-reports	FlaskConical	active	1370	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
clinic_vitals	Vitals	clinic	900.00	9000.00	clinic-vitals	Activity	active	1420	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
ecommerce_abandoned_cart	Abandoned Cart	ecommerce	1200.00	12000.00	ecommerce-abandoned-cart	ShoppingCart	active	1850	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
manufacturing_bom	Bill of Materials	manufacturing	1800.00	18000.00	manufacturing-bom	Layers	active	1870	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
manufacturing_production_orders	Production Orders	manufacturing	1800.00	18000.00	manufacturing-production	Cog	active	1880	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
manufacturing_workstations	Workstations	manufacturing	1200.00	12000.00	manufacturing-workstations	MonitorCog	active	1890	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
manufacturing_quality_control	Quality Control	manufacturing	1400.00	14000.00	manufacturing-quality	BadgeCheck	active	1900	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
manufacturing_material_planning	Material Planning	manufacturing	1600.00	16000.00	manufacturing-material-planning	Boxes	active	1910	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
manufacturing_costing	Production Costing	manufacturing	1500.00	15000.00	manufacturing-costing	Calculator	active	1920	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
manufacturing_maintenance	Machine Maintenance	manufacturing	1200.00	12000.00	manufacturing-maintenance	Wrench	active	1930	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
stock_transfer	Stock Transfer	store	1100.00	11000.00	stock-transfer	ArrowRightLeft	active	440	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
purchase_orders	Purchase Orders	store	1400.00	14000.00	purchase-orders	ShoppingCart	active	450	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
customer_loyalty	Customer Loyalty	store	1200.00	12000.00	loyalty	BadgePercent	active	460	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
online_storefront	Online Storefront	ecommerce	2500.00	25000.00	online-store	Globe	active	480	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
shipping_delivery	Shipping & Delivery	ecommerce	1200.00	12000.00	shipping	Truck	active	490	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
school_grades	Grades	school	1000.00	10000.00	school-grades	FileCheck	active	1290	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
school_hostel	Hostel	school	1300.00	13000.00	school-hostel	Bed	active	1310	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
school_lms	Learning Management	school	2200.00	22000.00	school-lms	BookOpen	active	1320	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
school_homework	Homework	school	900.00	9000.00	school-homework	NotebookPen	active	1330	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
clinic_pharmacy_stock	Pharmacy Stock	clinic	1400.00	14000.00	clinic-pharmacy	Pill	active	1380	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
clinic_queue_management	Queue Management	clinic	900.00	9000.00	clinic-queue	ListOrdered	active	1400	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
clinic_doctor_schedule	Doctor Schedule	clinic	1000.00	10000.00	clinic-doctor-schedule	CalendarDays	active	1410	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
clinic_insurance_claims	Insurance Claims	clinic	1500.00	15000.00	clinic-insurance	FilePlus2	active	1430	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
dental_treatment_plans	Treatment Plans	dental	1400.00	14000.00	dental-treatment-plans	FileText	active	1460	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
dental_lab_cases	Dental Lab Cases	dental	1200.00	12000.00	dental-lab-cases	FlaskConical	active	1480	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
dental_xray_records	X-Ray Records	dental	1200.00	12000.00	dental-xray	ScanLine	active	1490	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
dental_patient_recall	Patient Recall	dental	900.00	9000.00	dental-recall	BellRing	active	1500	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
salon_memberships	Memberships	salon	1000.00	10000.00	salon-memberships	BadgeCheck	active	1560	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
agriculture_fields	Fields & Lands	agriculture	1000.00	10000.00	agriculture-fields	Map	active	2430	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
agriculture_crops	Crops	agriculture	1200.00	12000.00	agriculture-crops	Wheat	active	2440	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
agriculture_livestock	Livestock	agriculture	1300.00	13000.00	agriculture-livestock	Beef	active	2450	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
agriculture_inputs	Seeds & Inputs	agriculture	1100.00	11000.00	agriculture-inputs	Package	active	2460	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
agriculture_harvest	Harvest Tracking	agriculture	1200.00	12000.00	agriculture-harvest	Tractor	active	2470	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
classes_sections	Classes & Sections	school	900.00	9000.00	classes	Layers	active	140	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
core_notifications	Notifications	core	700.00	7000.00	notifications	Bell	active	1070	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_activity_logs	Activity Logs	core	900.00	9000.00	activity-logs	ScrollText	active	1080	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_import_export	Import / Export	core	1000.00	10000.00	import-export	ArrowUpDown	active	1090	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_custom_fields	Custom Fields	core	900.00	9000.00	custom-fields	SlidersHorizontal	active	1100	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
core_tasks	Tasks	core	900.00	9000.00	tasks	CheckSquare	active	1110	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
store_pos_terminal	POS Terminal	store	1800.00	18000.00	store-pos	Monitor	active	1120	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
store_barcode_labeling	Barcode & Labeling	store	900.00	9000.00	store-barcode	ScanBarcode	active	1130	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
store_stock_transfer	Stock Transfer	store	1100.00	11000.00	store-stock-transfer	ArrowRightLeft	active	1140	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
store_purchase_orders	Purchase Orders	store	1400.00	14000.00	store-purchase-orders	ShoppingCart	active	1150	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
store_customer_loyalty	Customer Loyalty	store	1200.00	12000.00	store-loyalty	BadgePercent	active	1160	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
store_returns_refunds	Returns & Refunds	store	1000.00	10000.00	store-returns	Undo2	active	1170	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
store_price_lists	Price Lists	store	900.00	9000.00	store-price-lists	Tags	active	1180	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
store_low_stock_alerts	Low Stock Alerts	store	800.00	8000.00	store-low-stock	AlertTriangle	active	1190	2026-06-14 19:18:54.644363+00	2026-08-14 06:50:49.794936+00
school_admissions	Admissions	school	1200.00	12000.00	school-admissions	UserPlus	active	1280	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
school_online_classes	Online Classes	school	1500.00	15000.00	school-online-classes	Video	active	1340	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
clinic_medical_records	Medical Records	clinic	1600.00	16000.00	clinic-medical-records	FolderOpen	active	1360	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
store_management	Store Management	store	2500.00	25000.00	store	Package	active	10	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
products	Products	store	800.00	8000.00	products	Package	active	20	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
inventory	Inventory	store	1200.00	12000.00	inventory	Database	active	30	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
sales_orders	Sales & Orders	store	1500.00	15000.00	sales	WalletCards	active	40	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
construction_contractors	Contractors	construction	1200.00	12000.00	construction-contractors	Users	active	2230	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
construction_site_attendance	Site Attendance	construction	1000.00	10000.00	construction-site-attendance	MapPinned	active	2240	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
construction_progress_reports	Progress Reports	construction	1200.00	12000.00	construction-progress	BarChart3	active	2250	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
professional_services_management	Professional Services Management	professional_services	3000.00	30000.00	professional-services	Briefcase	active	2260	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
professional_services_clients	Clients	professional_services	1000.00	10000.00	professional-services-clients	Users	active	2270	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
professional_services_contracts	Contracts	professional_services	1200.00	12000.00	professional-services-contracts	FileText	active	2300	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
pos_terminal	POS Terminal	store	1800.00	18000.00	pos	Monitor	active	420	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
barcode_labeling	Barcode & Labeling	store	900.00	9000.00	barcode	ScanBarcode	active	430	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
reservations	Reservations	restaurant	1200.00	12000.00	reservations	CalendarCheck	active	500	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
delivery_orders	Delivery Orders	restaurant	1400.00	14000.00	delivery	Bike	active	510	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
food_inventory	Food Inventory	restaurant	1300.00	13000.00	food-inventory	Boxes	active	520	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
waiter_app	Waiter App	restaurant	1100.00	11000.00	waiter	Smartphone	active	530	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
recipe_costing	Recipe Costing	restaurant	1200.00	12000.00	recipe-costing	Calculator	active	540	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
admissions	Admissions	school	1200.00	12000.00	admissions	UserPlus	active	550	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
grades	Grades	school	1000.00	10000.00	grades	FileCheck	active	560	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
transport	Transport	school	1200.00	12000.00	transport	Bus	active	570	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
hostel	Hostel	school	1300.00	13000.00	hostel	Bed	active	580	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
lms	Learning Management	school	2200.00	22000.00	lms	BookOpen	active	590	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
medical_records	Medical Records	clinic	1600.00	16000.00	medical-records	FolderOpen	active	600	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
lab_reports	Lab Reports	clinic	1200.00	12000.00	lab-reports	FlaskConical	active	610	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
pharmacy_stock	Pharmacy Stock	clinic	1400.00	14000.00	pharmacy	Pill	active	620	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
patient_portal	Patient Portal	clinic	1600.00	16000.00	patient-portal	HeartPulse	active	630	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
queue_management	Queue Management	clinic	900.00	9000.00	queue	ListOrdered	active	640	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
treatment_plans	Treatment Plans	dental	1400.00	14000.00	treatment-plans	FileText	active	670	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
service_menu	Service Menu	salon	900.00	9000.00	services	List	active	700	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
staff_scheduling	Staff Scheduling	salon	1200.00	12000.00	staff-schedule	CalendarDays	active	710	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
memberships	Memberships	salon	1000.00	10000.00	memberships	BadgeCheck	active	720	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
commission	Staff Commission	salon	1100.00	11000.00	commission	Percent	active	730	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
room_booking	Room Booking	hotel	1600.00	16000.00	room-booking	BedDouble	active	750	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
housekeeping	Housekeeping	hotel	1000.00	10000.00	housekeeping	Sparkles	active	760	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
checkin_checkout	Check-in / Check-out	hotel	1200.00	12000.00	checkin	LogIn	active	770	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
repair_management	Repair Management	services	2500.00	25000.00	repair	Wrench	active	780	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
tickets	Tickets	services	1100.00	11000.00	tickets	Ticket	active	790	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
customers	Customers	store	1000.00	10000.00	customers	Users	active	50	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
suppliers	Suppliers	store	800.00	8000.00	suppliers	Building2	active	60	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
attendance	Attendance	school	1200.00	12000.00	attendance	CheckCircle	active	150	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
exams_results	Exams & Results	school	1400.00	14000.00	exams	FileText	active	170	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
timetable	Timetable	school	900.00	9000.00	timetable	Calendar	active	180	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
parents_portal	Parents Portal	school	1200.00	12000.00	parents	Users	active	190	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
library	Library	school	800.00	8000.00	library	BookOpen	active	200	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
menu_items	Menu Items	restaurant	900.00	9000.00	menu	List	active	240	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
clinic_patient_portal	Patient Portal	clinic	1600.00	16000.00	clinic-patient-portal	HeartPulse	active	1390	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
dental_orthodontics	Orthodontics	dental	1600.00	16000.00	dental-orthodontics	SmilePlus	active	1510	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
salon_service_menu	Service Menu	salon	900.00	9000.00	salon-services	List	active	1530	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
salon_booking	Booking	salon	1200.00	12000.00	salon-booking	CalendarCheck	active	1540	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
salon_staff_scheduling	Staff Scheduling	salon	1200.00	12000.00	salon-staff-schedule	CalendarDays	active	1550	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
hotel_room_booking	Room Booking	hotel	1600.00	16000.00	hotel-room-booking	BedDouble	active	1610	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
hotel_checkin_checkout	Check-in / Check-out	hotel	1200.00	12000.00	hotel-checkin	LogIn	active	1620	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
hotel_room_status	Room Status	hotel	1000.00	10000.00	hotel-room-status	DoorOpen	active	1630	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
hotel_housekeeping	Housekeeping	hotel	1000.00	10000.00	hotel-housekeeping	Sparkles	active	1640	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
hotel_guest_records	Guest Records	hotel	1000.00	10000.00	hotel-guests	Users	active	1650	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
hotel_deposits	Deposits	hotel	1000.00	10000.00	hotel-deposits	WalletCards	active	1660	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
hotel_rental_items	Rental Items	hotel	900.00	9000.00	hotel-rental-items	Boxes	active	1670	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
travel_management	Travel Management	travel	3500.00	35000.00	travel	Plane	active	1680	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
travel_packages	Tour Packages	travel	1400.00	14000.00	travel-packages	Map	active	1690	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
travel_bookings	Bookings	travel	1400.00	14000.00	travel-bookings	CalendarCheck	active	1700	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
travel_customers	Travel Customers	travel	1000.00	10000.00	travel-customers	Users	active	1710	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
travel_visa_documents	Visa Documents	travel	1200.00	12000.00	travel-visa-documents	FileText	active	1720	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
travel_flight_records	Flight Records	travel	1200.00	12000.00	travel-flights	PlaneTakeoff	active	1730	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
travel_hotel_reservations	Hotel Reservations	travel	1200.00	12000.00	travel-hotels	Hotel	active	1740	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
travel_commission	Travel Commission	travel	1100.00	11000.00	travel-commission	Percent	active	1750	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
billing	Billing & Invoices	store	1500.00	15000.00	billing	CreditCard	active	70	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
reports	Reports	store	1000.00	10000.00	reports	BarChart3	active	80	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
restaurant_management	Restaurant Management	restaurant	3000.00	30000.00	restaurant	Utensils	active	230	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
tables_orders	Tables & Orders	restaurant	1400.00	14000.00	tables	LayoutGrid	active	250	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
kitchen_display	Kitchen Display	restaurant	1300.00	13000.00	kitchen	Monitor	active	260	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
job_cards	Job Cards	services	1200.00	12000.00	job-cards	ClipboardList	active	800	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
field_staff	Field Staff	services	1300.00	13000.00	field-staff	MapPin	active	810	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
warranty	Warranty	services	1000.00	10000.00	warranty	ShieldCheck	active	820	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
bom	Bill of Materials	manufacturing	1800.00	18000.00	bom	Layers	active	840	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
production_orders	Production Orders	manufacturing	1800.00	18000.00	production	Cog	active	850	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
quality_control	Quality Control	manufacturing	1400.00	14000.00	quality	BadgeCheck	active	860	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
properties	Properties	real_estate	1400.00	14000.00	properties	Home	active	880	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
leads_pipeline	Leads Pipeline	real_estate	1300.00	13000.00	leads	GitBranch	active	890	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
rentals	Rentals	real_estate	1500.00	15000.00	rentals	Key	active	900	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
gym_management	Gym Management	gym	2500.00	25000.00	gym	Dumbbell	active	910	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
trainer_schedule	Trainer Schedule	gym	1000.00	10000.00	trainer-schedule	Calendar	active	920	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
fitness_memberships	Fitness Memberships	gym	1200.00	12000.00	fitness-memberships	BadgeCheck	active	930	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
accounting	Accounting	finance	2200.00	22000.00	accounting	Calculator	active	940	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
expenses	Expenses	finance	1000.00	10000.00	expenses	Receipt	active	950	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
ledger	Ledger	finance	1600.00	16000.00	ledger	BookText	active	960	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
tax_management	Tax Management	finance	1200.00	12000.00	tax	FileSpreadsheet	active	970	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
payment_records	Payment Records	payments	1500.00	15000.00	payments	WalletCards	active	980	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
subscription_billing	Subscription Billing	payments	1800.00	18000.00	subscriptions	Repeat	active	990	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
license_keys	License Keys	license	1800.00	18000.00	license-keys	Key	active	1000	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
rbac_roles	RBAC Roles	security	1600.00	16000.00	rbac	ShieldCheck	active	1010	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
audit_logs	Audit Logs	security	1400.00	14000.00	audit	ScrollText	active	1020	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
api_keys	API Keys	integrations	1500.00	15000.00	api-keys	KeyRound	active	1030	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
webhooks	Webhooks	integrations	1200.00	12000.00	webhooks	Webhook	active	1040	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
email_sms	Email / SMS	communication	1200.00	12000.00	messages	Mail	active	1050	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
whatsapp	WhatsApp	communication	1500.00	15000.00	whatsapp	MessageCircle	active	1060	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
analytics_dashboard	Analytics Dashboard	analytics	1800.00	18000.00	analytics	BarChart3	active	1070	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
custom_reports	Custom Reports	analytics	1600.00	16000.00	custom-reports	FileBarChart	active	1080	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
ai_assistant	AI Assistant	ai	2500.00	25000.00	ai-assistant	Bot	active	1090	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
ai_forecasting	AI Forecasting	ai	2200.00	22000.00	ai-forecast	TrendingUp	active	1100	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
workflow_automation	Workflow Automation	automation	2200.00	22000.00	automation	Workflow	active	1110	2026-06-14 23:06:59.331641+00	2026-08-14 06:50:49.787216+00
restaurant_billing	Restaurant Billing	restaurant	1500.00	15000.00	restaurant-billing	CreditCard	active	270	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
clinic_management	Clinic Management	clinic	3500.00	35000.00	clinic	Activity	active	300	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
patients	Patients	clinic	1200.00	12000.00	patients	Users	active	310	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
appointments	Appointments	clinic	1200.00	12000.00	appointments	Calendar	active	320	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
prescriptions	Prescriptions	clinic	1300.00	13000.00	prescriptions	FileText	active	340	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
clinic_billing	Clinic Billing	clinic	1500.00	15000.00	clinic-billing	CreditCard	active	350	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.794936+00
crm	CRM	business	2000.00	20000.00	crm	UserCog	active	400	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
website	Website / Landing Pages	business	1800.00	18000.00	website	Globe	active	410	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.794936+00
dental_management	Dental Management	dental	3500.00	35000.00	dental	Smile	active	1440	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
dental_charting	Dental Charting	dental	1800.00	18000.00	dental-charting	ClipboardList	active	1450	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
dental_billing	Dental Billing	dental	1300.00	13000.00	dental-billing	CreditCard	active	1470	2026-06-14 19:32:36.391233+00	2026-08-14 06:50:49.794936+00
salon_management	Salon Management	salon	2500.00	25000.00	salon	Scissors	active	1520	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
hotel_management	Hotel Management	hotel	3500.00	35000.00	hotel	Hotel	active	1600	2026-06-14 19:44:23.785827+00	2026-08-14 06:50:49.794936+00
ecommerce_management	Ecommerce Management	ecommerce	3500.00	35000.00	ecommerce	ShoppingBag	active	1760	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
ecommerce_storefront	Online Storefront	ecommerce	2500.00	25000.00	ecommerce-storefront	Globe	active	1770	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
ecommerce_orders	Online Orders	ecommerce	1800.00	18000.00	ecommerce-orders	ShoppingCart	active	1780	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
ecommerce_products	Ecommerce Products	ecommerce	1200.00	12000.00	ecommerce-products	Package	active	1790	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
ecommerce_cart_checkout	Cart & Checkout	ecommerce	1500.00	15000.00	ecommerce-checkout	CreditCard	active	1800	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
manufacturing_management	Manufacturing Management	manufacturing	4000.00	40000.00	manufacturing	Factory	active	1860	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
real_estate_management	Real Estate Management	real_estate	3000.00	30000.00	real-estate	Building	active	1940	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
real_estate_properties	Properties	real_estate	1400.00	14000.00	real-estate-properties	Home	active	1950	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
real_estate_leads	Leads Pipeline	real_estate	1300.00	13000.00	real-estate-leads	GitBranch	active	1960	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
real_estate_rentals	Rentals	real_estate	1500.00	15000.00	real-estate-rentals	Key	active	1970	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
real_estate_sales	Property Sales	real_estate	1600.00	16000.00	real-estate-sales	Handshake	active	1980	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
real_estate_visits	Site Visits	real_estate	900.00	9000.00	real-estate-visits	CalendarCheck	active	1990	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
real_estate_commission	Agent Commission	real_estate	1100.00	11000.00	real-estate-commission	Percent	active	2000	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
real_estate_documents	Property Documents	real_estate	1000.00	10000.00	real-estate-documents	FileText	active	2010	2026-06-14 19:53:37.252876+00	2026-08-14 06:50:49.794936+00
pharmacy_management	Pharmacy Management	pharmacy	3000.00	30000.00	pharmacy	Pill	active	2020	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
pharmacy_medicine_catalog	Medicine Catalog	pharmacy	1200.00	12000.00	pharmacy-medicines	Tablets	active	2030	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
pharmacy_inventory	Pharmacy Inventory	pharmacy	1400.00	14000.00	pharmacy-inventory	Boxes	active	2040	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
pharmacy_batch_expiry	Batch & Expiry Tracking	pharmacy	1300.00	13000.00	pharmacy-batch-expiry	CalendarClock	active	2050	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
pharmacy_prescription_sales	Prescription Sales	pharmacy	1400.00	14000.00	pharmacy-prescription-sales	FileText	active	2060	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
pharmacy_supplier_orders	Supplier Orders	pharmacy	1200.00	12000.00	pharmacy-supplier-orders	Truck	active	2070	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
pharmacy_low_stock_alerts	Low Stock Alerts	pharmacy	900.00	9000.00	pharmacy-low-stock	AlertTriangle	active	2080	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
pharmacy_compliance_reports	Compliance Reports	pharmacy	1100.00	11000.00	pharmacy-compliance	ShieldCheck	active	2090	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
logistics_management	Logistics Management	logistics	3500.00	35000.00	logistics	Truck	active	2100	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
logistics_shipments	Shipments	logistics	1500.00	15000.00	logistics-shipments	PackageCheck	active	2110	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
logistics_pickups	Pickups	logistics	1200.00	12000.00	logistics-pickups	PackagePlus	active	2120	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
logistics_delivery_tracking	Delivery Tracking	logistics	1600.00	16000.00	logistics-tracking	MapPin	active	2130	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
logistics_driver_management	Driver Management	logistics	1300.00	13000.00	logistics-drivers	Users	active	2140	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
logistics_vehicle_fleet	Vehicle Fleet	logistics	1400.00	14000.00	logistics-fleet	Truck	active	2150	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
logistics_cod_collection	COD Collection	logistics	1200.00	12000.00	logistics-cod	Wallet	active	2160	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
logistics_route_planning	Route Planning	logistics	1400.00	14000.00	logistics-routes	Route	active	2170	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
construction_management	Construction Management	construction	3500.00	35000.00	construction	HardHat	active	2180	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
construction_projects	Projects	construction	1600.00	16000.00	construction-projects	ClipboardList	active	2190	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
construction_materials	Materials	construction	1400.00	14000.00	construction-materials	Boxes	active	2200	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
construction_estimates	Estimates	construction	1300.00	13000.00	construction-estimates	Calculator	active	2210	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
construction_work_orders	Work Orders	construction	1400.00	14000.00	construction-work-orders	Wrench	active	2220	2026-06-14 20:04:20.036168+00	2026-08-14 06:50:49.794936+00
professional_services_projects	Client Projects	professional_services	1400.00	14000.00	professional-services-projects	ClipboardList	active	2280	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
professional_services_proposals	Proposals	professional_services	1200.00	12000.00	professional-services-proposals	FileSignature	active	2290	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
professional_services_time_tracking	Time Tracking	professional_services	1100.00	11000.00	professional-services-time	Clock	active	2310	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
professional_services_invoicing	Service Invoicing	professional_services	1300.00	13000.00	professional-services-invoicing	Receipt	active	2320	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
professional_services_retainer_billing	Retainer Billing	professional_services	1200.00	12000.00	professional-services-retainers	WalletCards	active	2330	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
ngo_management	NGO Management	ngo	2500.00	25000.00	ngo	HeartHandshake	active	2340	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
ngo_donors	Donors	ngo	1000.00	10000.00	ngo-donors	Users	active	2350	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
ngo_donations	Donations	ngo	1200.00	12000.00	ngo-donations	HandCoins	active	2360	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
ngo_campaigns	Campaigns	ngo	1200.00	12000.00	ngo-campaigns	Megaphone	active	2370	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
ngo_beneficiaries	Beneficiaries	ngo	1100.00	11000.00	ngo-beneficiaries	UserRoundCheck	active	2380	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
ngo_volunteers	Volunteers	ngo	1000.00	10000.00	ngo-volunteers	UsersRound	active	2390	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
ngo_grants	Grants	ngo	1300.00	13000.00	ngo-grants	FilePlus2	active	2400	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
ngo_impact_reports	Impact Reports	ngo	1100.00	11000.00	ngo-impact-reports	BarChart3	active	2410	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
agriculture_management	Agriculture Management	agriculture	2800.00	28000.00	agriculture	Sprout	active	2420	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
agriculture_expenses	Farm Expenses	agriculture	1000.00	10000.00	agriculture-expenses	Receipt	active	2480	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
agriculture_sales	Crop Sales	agriculture	1200.00	12000.00	agriculture-sales	Handshake	active	2490	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
auto_workshop_management	Auto Workshop Management	auto_workshop	3000.00	30000.00	auto-workshop	Wrench	active	2500	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
auto_workshop_jobs	Repair Jobs	auto_workshop	1400.00	14000.00	auto-workshop-jobs	ClipboardList	active	2510	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
auto_workshop_vehicles	Customer Vehicles	auto_workshop	1200.00	12000.00	auto-workshop-vehicles	Car	active	2520	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
auto_workshop_parts_inventory	Parts Inventory	auto_workshop	1400.00	14000.00	auto-workshop-parts	Boxes	active	2530	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
auto_workshop_service_history	Service History	auto_workshop	1100.00	11000.00	auto-workshop-service-history	History	active	2540	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
auto_workshop_estimates	Repair Estimates	auto_workshop	1000.00	10000.00	auto-workshop-estimates	Calculator	active	2550	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
auto_workshop_mechanics	Mechanics	auto_workshop	1000.00	10000.00	auto-workshop-mechanics	Users	active	2560	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
auto_workshop_billing	Workshop Billing	auto_workshop	1300.00	13000.00	auto-workshop-billing	Receipt	active	2570	2026-06-14 20:11:59.249437+00	2026-08-14 06:50:49.794936+00
event_management	Event Management	event_management	3000.00	30000.00	event-management	PartyPopper	active	2580	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
event_clients	Event Clients	event_management	1000.00	10000.00	event-clients	Users	active	2590	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
event_bookings	Event Bookings	event_management	1400.00	14000.00	event-bookings	CalendarCheck	active	2600	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
event_venues	Venues	event_management	1200.00	12000.00	event-venues	MapPin	active	2610	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
event_vendor_management	Vendor Management	event_management	1200.00	12000.00	event-vendors	Handshake	active	2620	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
event_budgeting	Event Budgeting	event_management	1300.00	13000.00	event-budgeting	Calculator	active	2630	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
event_tasks	Event Tasks	event_management	1000.00	10000.00	event-tasks	CheckSquare	active	2640	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
event_invoicing	Event Invoicing	event_management	1300.00	13000.00	event-invoicing	Receipt	active	2650	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
law_firm_management	Law Firm Management	law_firm	3500.00	35000.00	law-firm	Scale	active	2660	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
law_clients	Legal Clients	law_firm	1100.00	11000.00	law-clients	Users	active	2670	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
law_cases	Cases	law_firm	1600.00	16000.00	law-cases	Briefcase	active	2680	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
law_hearings	Hearings	law_firm	1200.00	12000.00	law-hearings	CalendarDays	active	2690	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
law_documents	Legal Documents	law_firm	1300.00	13000.00	law-documents	FileText	active	2700	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
law_billing	Legal Billing	law_firm	1400.00	14000.00	law-billing	Receipt	active	2710	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
law_time_tracking	Legal Time Tracking	law_firm	1200.00	12000.00	law-time-tracking	Clock	active	2720	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
law_compliance	Compliance	law_firm	1200.00	12000.00	law-compliance	ShieldCheck	active	2730	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
accounting_tax_management	Accounting & Tax Management	accounting_tax	3500.00	35000.00	accounting-tax	Calculator	active	2740	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
accounting_clients	Accounting Clients	accounting_tax	1000.00	10000.00	accounting-clients	Users	active	2750	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
accounting_bookkeeping	Bookkeeping	accounting_tax	1500.00	15000.00	accounting-bookkeeping	BookOpen	active	2760	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
accounting_tax_returns	Tax Returns	accounting_tax	1600.00	16000.00	accounting-tax-returns	FileCheck	active	2770	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
accounting_expenses	Expense Tracking	accounting_tax	1000.00	10000.00	accounting-expenses	Receipt	active	2780	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
accounting_reports	Financial Reports	accounting_tax	1300.00	13000.00	accounting-reports	BarChart3	active	2790	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
accounting_payroll	Payroll	accounting_tax	1500.00	15000.00	accounting-payroll	WalletCards	active	2800	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
accounting_audit_files	Audit Files	accounting_tax	1200.00	12000.00	accounting-audit-files	FolderOpen	active	2810	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
hr_recruitment_management	HR & Recruitment Management	hr_recruitment	3500.00	35000.00	hr-recruitment	UsersRound	active	2820	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
hr_candidates	Candidates	hr_recruitment	1200.00	12000.00	hr-candidates	UserRoundPlus	active	2830	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
hr_jobs	Job Openings	hr_recruitment	1200.00	12000.00	hr-jobs	BriefcaseBusiness	active	2840	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
hr_applications	Applications	hr_recruitment	1300.00	13000.00	hr-applications	FileUser	active	2850	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
hr_interviews	Interviews	hr_recruitment	1200.00	12000.00	hr-interviews	CalendarCheck	active	2860	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
hr_clients	Recruitment Clients	hr_recruitment	1000.00	10000.00	hr-clients	Building2	active	2870	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
hr_offer_letters	Offer Letters	hr_recruitment	1000.00	10000.00	hr-offer-letters	FileSignature	active	2880	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
hr_onboarding	Onboarding	hr_recruitment	1300.00	13000.00	hr-onboarding	UserCheck	active	2890	2026-06-14 20:23:56.438157+00	2026-08-14 06:50:49.794936+00
\.
...
store_start	Store Start	2500.00	25000.00	inactive	10	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.793299+00
store_pro	Store Pro	5500.00	55000.00	inactive	20	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.793299+00
school_start	School Start	4500.00	45000.00	inactive	30	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.793299+00
school_pro	School Pro	9500.00	95000.00	inactive	40	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.793299+00
restaurant_start	Restaurant Start	3500.00	35000.00	inactive	50	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.793299+00
restaurant_pro	Restaurant Pro	7500.00	75000.00	inactive	60	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.793299+00
clinic_start	Clinic Start	4500.00	45000.00	inactive	70	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.793299+00
clinic_pro	Clinic Pro	8500.00	85000.00	inactive	80	2026-06-10 09:34:21.634902+00	2026-08-14 06:50:49.793299+00
business_plus	Business Plus	12000.00	120000.00	inactive	90	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.793299+00
enterprise_manual	Enterprise Manual	0.00	0.00	inactive	100	2026-06-09 21:27:23.00887+00	2026-08-14 06:50:49.793299+00
\.
...
\unrestrict dcbScWmWf2PhPZVakUUeRZ9I09bJv76R8JaFSE6dhU55tJkaJ16f01kwi7Jf4eC
